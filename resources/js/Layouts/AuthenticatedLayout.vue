                ...
                <div class="container sm:px-6 lg:px-8">
                    <div class="flex h-16 justify-between">
                        ...
                        <div class="hidden sm:ms-6 sm:flex sm:items-center">
                            ...
                            <!-- <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('job-postings.index')">
                                    Jobs
                                </NavLink>
                            </div> -->
                            <div class="relative ms-3">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        <DropdownLink :href="route('job-postings.index')">
                                            Jobs Create
                                        </DropdownLink>
                                ...
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <a class="block w-full px-4 py-2 text-start text-sm leading-5 text-gray-700 transition duration-150 ease-in-out hover:bg-gray-100 focus:bg-gray-100 focus:outline-none dark:text-gray-300 dark:hover:bg-gray-800 dark:focus:bg-gray-800"
                                            :href="route('admin.dashboard')" v-if="authHasRole('admin')">
                                            Admin Dashboard
                                        </a>
